...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (typeof(elem) == 'string') {
			elem = $(webcamPlayer.id_content).children();
			elem = elem[0];
		...
		if (this.userMedia) {
			...
			function(err) {
				setTimeout(function(){
					webcamPlayer.notAvailable = 1;   /// set not available..
					swal({
					    ...
					    confirmButtonText : "Fine, No Camera For Me.",
	...
	// getImage: function(image_data_uri, target_url) {
