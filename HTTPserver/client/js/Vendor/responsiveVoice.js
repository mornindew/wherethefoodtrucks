...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
                            ...
                            if (voicesupport_attempts > VOICESUPPORT_ATTEMPTLIMIT) {
                                ...
                                if (window.speechSynthesis != null) {
                                    ...
                                    if (self.iOS) {
                                        ...
                                        console.log(">>> Text2Speach - speechSynthesis present but no system voices found");
                                        self.enableFallbackMode();
                                    }
        ...
        self.enableFallbackMode = function() {
            console.log('>>>  Enabling Text to Speach - Fallback Mode');
        ...
        self.speak = function (text, voicename, parameters) {
            ...
            for (var i = 0; i < multipartText.length; i++) {
                ...
                if (!fallbackMode) {
                    ...
                    // alert("Remote Fetching Of Voices Turned Off..");
                    //var url = 'http://www.corsproxy.com/translate.google.com/translate_tts?ie=UTF-8&q=' + multipartText[i] + '&tl=' + profile.collectionvoice.lang || profile.systemvoice.lang || 'en-US';
                        // if(confirm("Fetch Remote Text to Speach Voice File") ){
                            /// Look for network Access here..
                            try{
                                ...
                                self.fallback_parts.push(audio);
                                    console.log(">> Playing Voice in fallback mode :");
                                    console.log(audio);
                            }catch(err){
                                console.log("Failed to Fetch Remote Text to Voice File.");
                            }
                        // }
                }
